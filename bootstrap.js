...
}(this, (function ()
{
	...
	const P = {
		...
		{
			if ("string" != typeof e || !t) return;
			const [s, o, r] = L(e, i, n), a = r !== e, l = x(t), c = l[r] ||
			{}, h = e.startsWith(".");
			if (void 0 === o)
			{
				if (h)
	...
	const he = {
		...
		fn: function (t)
		{
			...
			if (o && r)
			{
				var h = function (t, e)
					{
						return le("number" != typeof (t = "function" == typeof t ? t(Object.assign(
						{}, e.rects,
						{
	...
	function fe(t)
	{
		...
		{}, O, ((C = {})[y] = b ? "0" : "", C[v] = _ ? "0" : "", C.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + f + "px, " + g + "px)" : "translate3d(" + f + "px, " + g + "px, 0)", C)) : Object.assign(
	...
	const pe = {
		...
		fn: function (t)
		{
			...
			{}, e.styles.popper, fe(Object.assign(
			{}, c,
			{
		...
		He = {
			...
			fn: function (t)
			{
				var e = t.state,
					...
					E = e.rects.reference,
					T = e.rects.popper,
					C = "function" == typeof g ? g(Object.assign(
					{}, e.rects,
					{
						placement: e.placement
					})) : g,
